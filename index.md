...
I.[Metinfo-6.1.2-SQL注入脚本](https://github.com/xiazibet/super-guacamole/tree/master/Metinfo-6.1.2-SQL%E6%B3%A8%E5%85%A5)
...
I.[从任意文件读取到GetShell](https://xz.aliyun.com/t/6958)

I.[Discuz!X ≤3.4 任意文件删除漏洞分析](https://paper.seebug.org/411/)
...
I.[SqlServer提权](https://mp.weixin.qq.com/s/qMv_Yw1xMT1Wv1ttWAA0lQ)

I.[一个有趣的Shell分析以及自己的一些想法](https://www.secquan.org/Discuss/1070664)

I.[某bc的越权修改任意用户密码](https://mp.weixin.qq.com/s/URPJPbmRixfWPKFDaX1qFA)

I.[phpMyAdmin 渗透利用总结](https://mp.weixin.qq.com/s/9Tkcn2AtGrHUsIbRCQ-ZSQ)

I.[报告永安在线发布《黑产攻击流程自动化体系》详解黑产自动化攻击](https://www.freebuf.com/articles/paper/223589.html)

I.[某CMS后台远程代码执行漏洞](https://xz.aliyun.com/t/6974)

I.[WordPress <= 5.3.x DoS](https://github.com/roddux/wordpress-dos-poc)

I.[原创干货 认识CORS漏洞](https://mp.weixin.qq.com/s/J11CnjkGTa1ILHdFqMhGDA)

I.[多种姿势openrasp命令执行绕过](https://www.anquanke.com/post/id/195016)

I.[5位可控字符下的任意命令执行 – 另一种解题方法](https://www.secpulse.com/archives/120302.html)

I.[OkayCMS 2.3.4 反序列化漏洞(CVE-2019-16885)](https://xz.aliyun.com/t/6929)

I.[Vimeo上传功能中的SSRF]( https://nosec.org/home/detail/3468.html)
